    ...
    render() { 
        return ( 
            <Container>
                ...
                <Row>
                    <ModuloJuego modo={this.props.modo} RespuestaCorrecta={this.state.Pregunta.ValorI/this.state.Pregunta.ValorD} VDC={this.state.Pregunta.ValorD} VIC={this.state.Pregunta.ValorI}/>
                </Row>
            </Container>
         );
    }
